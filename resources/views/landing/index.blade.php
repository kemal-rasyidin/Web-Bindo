...
<html lang="en">
  ...
  <body style="background-color: rgb(27, 27, 27);">
    ...
    <div class="fixed-top">
      <nav class="navbar navbar-expand-lg navbar-dark" style="height: 100px; background-color: rgb(27,27,27); background-size: cover;">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0" style="margin-left: 850px;">
            ...
            <button type="button" class="btn" style="background-color: transparent; color:white" data-toggle="modal" data-target="#exampleModal">
              Kontak
            </button>
            @guest
            @if (Route::has('login'))
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body bg-dark text-white">
                <i class="fas fa-phone"></i> : +62 856-9418-4754 <br>
                <i class="fas fa-envelope-square"></i> : strabhaknews@gmail.com <br>
                <i class="fab fa-instagram"></i> : @starbhak_news <br>
                <i class="fab fa-facebook"></i> : starbhaknews <br>
              </div>
      ...
      <div class="container" style="color: white; margin-bottom:50px;">
        ...
        <div class="container" style="color: white;">
            ...
            <table class="table text-white mt-5">
              ...
              <div class="row">
                  <div class="col">
                    <input class="mt-4 text-white" type="hidden" name="name" value="{{ Auth::user()->name }}">

                      <input class="mt-4 text-white" type="text" placeholder="Tulis Komentar Publik..." style="width: 100%; background-color: rgba(255, 255, 255, 0.048);" name="komentar" value="{{old('komen')}}">
                </div>
